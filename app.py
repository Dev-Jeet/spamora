...
model = pickle.load(
    open(
        r"C:\Users\jeetr\OneDrive\Desktop\spam project\models\spamora_model.pkl",
        "rb"
    )
)
...
tfidf = pickle.load(
    open(
        r"C:\Users\jeetr\OneDrive\Desktop\spam project\models\vectorizer.pkl",
        "rb"
    )
)
...
encoder = pickle.load(
    open(
        r"C:\Users\jeetr\OneDrive\Desktop\spam project\models\label_encoder.pkl",
        "rb"
    )
)
